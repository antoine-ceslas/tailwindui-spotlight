...
import image1 from '@/images/photos/ivalid.png'
import image2 from '@/images/photos/vsjnatation.png'
import image3 from '@/images/photos/pinkbeer.png'
import image4 from '@/images/photos/redbeer.png'
import image5 from '@/images/photos/vsjcalendar.png'
  ...
  return (
    ...
    >
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Restez à jour</span>
      </h2>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Recevez une notification lorsque je publie quelque chose de nouveau, et désabonnez-vous à tout moment.
      </p>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Développeur web full stack et mobile passionné.
          </h1>
